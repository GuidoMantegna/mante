...
1. **Crea una rama** `specs/<name>` a partir de rama actual del working tree que contenga los cambios realizados.
2. **Lee** `AGENTS.md`, `docs/architecture.md`, `docs/specs.md`. Para
   nombres, tests y reglas de Server/Client/estado/estilos, invoca el
   skill `project-conventions` (Skill tool) en vez de releer
